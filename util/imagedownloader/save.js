(function(){
    ...
    var save_deviantart = function($, record){
        ...
        record.id = dlbutton.attr("data-deviationid"); // ID
        record.url = dlbutton.attr("href"); // URL
        
        record.artist = location.hostname.substring(0, location.hostname.indexOf(".") - 1); // Artist
        record.title = $("div.dev-title-container > h1 > a").html(); // Title
